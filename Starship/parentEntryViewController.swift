...
class parentEntryViewController: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource, LineChartDelegate {
    ...
    var classImgs = ["train1.jpg", "train2.jpg", "train3.jpg"]
    var classTypes = ["生活技能", "生活技能", "生活技能"]
    var classNames = ["洗手", "刷牙", "洗澡", "綁鞋帶", "用筷子", "玩黏土"]
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if collectionView == self.rewardCollectionView {
            ...
            if indexPath.section == 0 {
                ...
                cell.startBtn.addTarget(self, action: #selector(parentEntryViewController.startGame), for: UIControlEvents.touchUpInside)
